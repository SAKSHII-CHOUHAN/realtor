...
//   const [geoLocationEnabled, setGeoLocationEnabled] = useState(false);
  ...
  async function onSubmit(e) {
    ...
    //     const response = await fetch(`https://maps.goggleapis.com/maps/api/geocode/json?address=${address}&key=${process.env.GEOCODE_API_KEY}`)
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300
                        transition duration-150 ease-in-out rounded focus:bg-white focus:text-gray-700 focus:border-slate-700
                        text-center"
              />
            </div>
            <div>
